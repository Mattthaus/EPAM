<%@ page import="by.epam.cheapair.domain.Flight" %>
<%@ page import="java.util.ArrayList" %>
<%@ page import="by.epam.cheapair.domain.Ticket" %>
<%@ page import="by.epam.cheapair.RestManagerUtil" %>
<%--
...
<main>
    ...
    <div style="text-align:center; margin-top: -25px;">
        <h1>Flights</h1>
        <p>Easy to buy - have a got flight!</p>
    </div>
    ...
    <div>
        <div style="text-align:center;margin-bottom: 15px;">
            <%
                // проверяется сессия на данные, если ли они или нет, если пусто - то гость, если нет - то уже зареган
        ...
        <div class="flights-container">
            <%
                // Управление дпнными через RESTAPI (файл RestManagerUtil)
        ...
        <div class="flights-container">
            <%
                // output of user ordered tickets (out - метод TomCat )
    ...
    %>>
        <!-- Если админ - то появляется доп кнопка для управления -->
